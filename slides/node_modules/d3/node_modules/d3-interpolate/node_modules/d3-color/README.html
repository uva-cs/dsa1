...
href="https://github.com/d3/d3-color/blob/master/src/color.js"
title="Source">&lt;&gt;</a></p>
...
<p><a name="color_hex" href="#color_hex">#</a>
<em>color</em>.<b>hex</b>() <a
href="https://github.com/d3/d3-color/blob/master/src/color.js"
title="Source">&lt;&gt;</a></p>
<p>Returns a hexadecimal string representing this color in RGB space,
such as <code>#f7eaba</code>. If this color is not displayable, a
suitable displayable color is returned instead. For example, RGB channel
values greater than 255 are clamped to 255.</p>
...
or <code>rgba(247, 234, 186, 0.2)</code>. If this color is not
displayable, a suitable displayable color is returned instead. For
example, RGB channel values greater than 255 are clamped to 255.</p>
...
<i>b</i>[, <i>opacity</i>]) <a
href="https://github.com/d3/d3-color/blob/master/src/lab.js"
...
picker</a> to explore this color space. The value of <em>l</em> is
typically in the range [0, 100], while <em>a</em> and <em>b</em> are
typically in [-160, +160].</p>
...
directly to Lab.)</p>
<p><a name="gray" href="#gray">#</a> d3.<b>gray</b>(<i>l</i>[,
<i>opacity</i>]) <a
href="https://github.com/d3/d3-color/blob/master/src/lab.js"
title="Source">&lt;&gt;</a><br></p>
<p>Constructs a new <a href="#lab">Lab</a> color with the specified
<em>l</em> value and <em>a</em> = <em>b</em> = 0.</p>
...
<p>Constructs a new <a
href="https://en.wikipedia.org/wiki/HCL_color_space">HCL</a> color. The
channel values are exposed as <code>h</code>, <code>c</code> and
<code>l</code> properties on the returned instance. Use the <a
href="http://bl.ocks.org/mbostock/3e115519a1b495e0bd95">HCL color
picker</a> to explore this color space. The value of <em>l</em> is
typically in the range [0, 100], <em>c</em> is typically in [0, 230],
and <em>h</em> is typically in [0, 360).</p>
...
directly to HCL.)</p>
<p><a name="lch" href="#lch">#</a> d3.<b>lch</b>(<i>l</i>, <i>c</i>,
<i>h</i>[, <i>opacity</i>]) <a
href="https://github.com/d3/d3-color/blob/master/src/lab.js"
title="Source">&lt;&gt;</a><br> <a href="#lch">#</a>
d3.<b>lch</b>(<i>specifier</i>)<br> <a href="#lch">#</a>
d3.<b>lch</b>(<i>color</i>)<br></p>
<p>Equivalent to <a href="#hcl">d3.hcl</a>, but with reversed argument
order.</p>
<p><a name="cubehelix" href="#cubehelix">#</a>
d3.<b>cubehelix</b>(<i>h</i>, <i>s</i>, <i>l</i>[, <i>opacity</i>]) <a
href="https://github.com/d3/d3-color/blob/master/src/cubehelix.js"
