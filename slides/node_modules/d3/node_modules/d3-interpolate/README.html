...
<div class="sourceCode"><pre class="sourceCode js"><code class="sourceCode javascript"><span class="kw">var</span> i <span class="op">=</span> <span class="va">d3</span>.<span class="at">interpolateNumber</span>(<span class="dv">10</span><span class="op">,</span> <span class="dv">20</span>)<span class="op">;</span>
<span class="at">i</span>(<span class="fl">0.0</span>)<span class="op">;</span> <span class="co">// 10</span>
<span class="at">i</span>(<span class="fl">0.2</span>)<span class="op">;</span> <span class="co">// 12</span>
<span class="at">i</span>(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// 15</span>
<span class="at">i</span>(<span class="fl">1.0</span>)<span class="op">;</span> <span class="co">// 20</span></code></pre></div>
...
<div class="sourceCode"><pre class="sourceCode js"><code class="sourceCode javascript"><span class="va">d3</span>.<span class="at">interpolateLab</span>(<span class="st">&quot;steelblue&quot;</span><span class="op">,</span> <span class="st">&quot;brown&quot;</span>)(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// &quot;rgb(142, 92, 109)&quot;</span></code></pre></div>
<p>Here’s a more elaborate example demonstrating type inference used by <a href="#interpolate">interpolate</a>:</p>
<div class="sourceCode"><pre class="sourceCode js"><code class="sourceCode javascript"><span class="kw">var</span> i <span class="op">=</span> <span class="va">d3</span>.<span class="at">interpolate</span>(<span class="op">{</span><span class="dt">colors</span><span class="op">:</span> [<span class="st">&quot;red&quot;</span><span class="op">,</span> <span class="st">&quot;blue&quot;</span>]<span class="op">},</span> <span class="op">{</span><span class="dt">colors</span><span class="op">:</span> [<span class="st">&quot;white&quot;</span><span class="op">,</span> <span class="st">&quot;black&quot;</span>]<span class="op">}</span>)<span class="op">;</span>
<span class="at">i</span>(<span class="fl">0.0</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 0, 0)&quot;, &quot;rgb(0, 0, 255)&quot;]}</span>
<span class="at">i</span>(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 128, 128)&quot;, &quot;rgb(0, 0, 128)&quot;]}</span>
<span class="at">i</span>(<span class="fl">1.0</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 255, 255)&quot;, &quot;rgb(0, 0, 0)&quot;]}</span></code></pre></div>
...
<div class="sourceCode"><pre class="sourceCode html"><code class="sourceCode html"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-color.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span>
<span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-interpolate.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span>
<span class="kw">&lt;script&gt;</span>

<span class="kw">var</span> interpolate <span class="op">=</span> <span class="va">d3</span>.<span class="at">interpolateRgb</span>(<span class="st">&quot;steelblue&quot;</span><span class="op">,</span> <span class="st">&quot;brown&quot;</span>)<span class="op">;</span>
...
<div class="sourceCode"><pre class="sourceCode js"><code class="sourceCode javascript"><span class="kw">function</span> <span class="at">interpolator</span>(t) <span class="op">{</span>
  <span class="cf">return</span> a <span class="op">*</span> (<span class="dv">1</span> <span class="op">-</span> t) <span class="op">+</span> b <span class="op">*</span> t<span class="op">;</span>
...
<div class="sourceCode"><pre class="sourceCode js"><code class="sourceCode javascript"><span class="kw">var</span> interpolator <span class="op">=</span> <span class="va">d3</span>.<span class="va">interpolateRgb</span>.<span class="at">gamma</span>(<span class="fl">2.2</span>)(<span class="st">&quot;purple&quot;</span><span class="op">,</span> <span class="st">&quot;orange&quot;</span>)<span class="op">;</span></code></pre></div>
