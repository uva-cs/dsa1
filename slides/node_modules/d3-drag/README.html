...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-dispatch.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-2" title="2"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-selection.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-3" title="3"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-drag.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-4" title="4"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb1-5" title="5"></a>
<a class="sourceLine" id="cb1-6" title="6"><span class="kw">var</span> drag <span class="op">=</span> <span class="va">d3</span>.<span class="at">drag</span>()<span class="op">;</span></a>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="va">d3</span>.<span class="at">selectAll</span>(<span class="st">&quot;.node&quot;</span>).<span class="at">call</span>(<span class="va">d3</span>.<span class="at">drag</span>().<span class="at">on</span>(<span class="st">&quot;start&quot;</span><span class="op">,</span> started))<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="va">selection</span>.<span class="at">on</span>(<span class="st">&quot;.drag&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="kw">function</span> <span class="at">container</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb4-2" title="2">  <span class="cf">return</span> <span class="kw">this</span>.<span class="at">parentNode</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">function</span> <span class="at">container</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb5-2" title="2">  <span class="cf">return</span> <span class="kw">this</span><span class="op">;</span></a>
...
<a class="sourceLine" id="cb6-2" title="2">  <span class="cf">return</span> <span class="op">!</span><span class="va">d3</span>.<span class="va">event</span>.<span class="at">button</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">function</span> <span class="at">touchable</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb7-2" title="2">  <span class="cf">return</span> <span class="st">&quot;ontouchstart&quot;</span> <span class="kw">in</span> <span class="kw">this</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb8-1" title="1"><span class="kw">function</span> <span class="at">subject</span>(d) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-2" title="2">  <span class="cf">return</span> d <span class="op">==</span> <span class="kw">null</span> <span class="op">?</span> <span class="op">{</span><span class="dt">x</span><span class="op">:</span> <span class="va">d3</span>.<span class="va">event</span>.<span class="at">x</span><span class="op">,</span> <span class="dt">y</span><span class="op">:</span> <span class="va">d3</span>.<span class="va">event</span>.<span class="at">y</span><span class="op">}</span> : d<span class="op">;</span></a>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb9-1" title="1"><span class="kw">function</span> <span class="at">subject</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb9-2" title="2">  <span class="kw">var</span> n <span class="op">=</span> <span class="va">circles</span>.<span class="at">length</span><span class="op">,</span></a>
<a class="sourceLine" id="cb9-3" title="3">      i<span class="op">,</span></a>
<a class="sourceLine" id="cb9-4" title="4">      dx<span class="op">,</span></a>
<a class="sourceLine" id="cb9-5" title="5">      dy<span class="op">,</span></a>
<a class="sourceLine" id="cb9-6" title="6">      d2<span class="op">,</span></a>
<a class="sourceLine" id="cb9-7" title="7">      s2 <span class="op">=</span> radius <span class="op">*</span> radius<span class="op">,</span></a>
<a class="sourceLine" id="cb9-8" title="8">      circle<span class="op">,</span></a>
<a class="sourceLine" id="cb9-9" title="9">      subject<span class="op">;</span></a>
<a class="sourceLine" id="cb9-10" title="10"></a>
<a class="sourceLine" id="cb9-11" title="11">  <span class="cf">for</span> (i <span class="op">=</span> <span class="dv">0</span><span class="op">;</span> i <span class="op">&lt;</span> n<span class="op">;</span> <span class="op">++</span>i) <span class="op">{</span></a>
<a class="sourceLine" id="cb9-12" title="12">    circle <span class="op">=</span> circles[i]<span class="op">;</span></a>
<a class="sourceLine" id="cb9-13" title="13">    dx <span class="op">=</span> <span class="va">d3</span>.<span class="va">event</span>.<span class="at">x</span> <span class="op">-</span> <span class="va">circle</span>.<span class="at">x</span><span class="op">;</span></a>
<a class="sourceLine" id="cb9-14" title="14">    dy <span class="op">=</span> <span class="va">d3</span>.<span class="va">event</span>.<span class="at">y</span> <span class="op">-</span> <span class="va">circle</span>.<span class="at">y</span><span class="op">;</span></a>
<a class="sourceLine" id="cb9-15" title="15">    d2 <span class="op">=</span> dx <span class="op">*</span> dx <span class="op">+</span> dy <span class="op">*</span> dy<span class="op">;</span></a>
<a class="sourceLine" id="cb9-16" title="16">    <span class="cf">if</span> (d2 <span class="op">&lt;</span> s2) subject <span class="op">=</span> circle<span class="op">,</span> s2 <span class="op">=</span> d2<span class="op">;</span></a>
<a class="sourceLine" id="cb9-17" title="17">  <span class="op">}</span></a>
<a class="sourceLine" id="cb9-18" title="18"></a>
<a class="sourceLine" id="cb9-19" title="19">  <span class="cf">return</span> subject<span class="op">;</span></a>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb10-1" title="1"><span class="kw">function</span> <span class="at">started</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb10-2" title="2">  <span class="kw">var</span> circle <span class="op">=</span> <span class="va">d3</span>.<span class="at">select</span>(<span class="kw">this</span>).<span class="at">classed</span>(<span class="st">&quot;dragging&quot;</span><span class="op">,</span> <span class="kw">true</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb10-3" title="3"></a>
<a class="sourceLine" id="cb10-4" title="4">  <span class="va">d3</span>.<span class="va">event</span>.<span class="at">on</span>(<span class="st">&quot;drag&quot;</span><span class="op">,</span> dragged).<span class="at">on</span>(<span class="st">&quot;end&quot;</span><span class="op">,</span> ended)<span class="op">;</span></a>
<a class="sourceLine" id="cb10-5" title="5"></a>
<a class="sourceLine" id="cb10-6" title="6">  <span class="kw">function</span> <span class="at">dragged</span>(d) <span class="op">{</span></a>
<a class="sourceLine" id="cb10-7" title="7">    <span class="va">circle</span>.<span class="at">raise</span>().<span class="at">attr</span>(<span class="st">&quot;cx&quot;</span><span class="op">,</span> <span class="va">d</span>.<span class="at">x</span> <span class="op">=</span> <span class="va">d3</span>.<span class="va">event</span>.<span class="at">x</span>).<span class="at">attr</span>(<span class="st">&quot;cy&quot;</span><span class="op">,</span> <span class="va">d</span>.<span class="at">y</span> <span class="op">=</span> <span class="va">d3</span>.<span class="va">event</span>.<span class="at">y</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb10-8" title="8">  <span class="op">}</span></a>
<a class="sourceLine" id="cb10-9" title="9"></a>
<a class="sourceLine" id="cb10-10" title="10">  <span class="kw">function</span> <span class="at">ended</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb10-11" title="11">    <span class="va">circle</span>.<span class="at">classed</span>(<span class="st">&quot;dragging&quot;</span><span class="op">,</span> <span class="kw">false</span>)<span class="op">;</span></a>
