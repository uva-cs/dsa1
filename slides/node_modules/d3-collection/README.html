...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb10-1"><a href="#cb10-1" aria-hidden="true" tabindex="-1"></a><span class="kw">var</span> entries <span class="op">=</span> d3<span class="op">.</span><span class="fu">nest</span>()</span>
