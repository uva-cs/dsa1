...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">var</span> formatTime <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%B %d, %Y&quot;</span>)<span class="op">;</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a><span class="fu">formatTime</span>(<span class="kw">new</span> <span class="bu">Date</span>)<span class="op">;</span> <span class="co">// &quot;June 30, 2015&quot;</span></span></code></pre></div>
<p>Likewise, to convert a string back to a date, create a <a href="#locale_parse">parser</a>:</p>
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true"></a><span class="kw">var</span> parseTime <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeParse</span>(<span class="st">&quot;%B %d, %Y&quot;</span>)<span class="op">;</span></span>
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true"></a><span class="fu">parseTime</span>(<span class="st">&quot;June 30, 2015&quot;</span>)<span class="op">;</span> <span class="co">// Tue Jun 30 2015 00:00:00 GMT-0700 (PDT)</span></span></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a><span class="kw">var</span> formatMillisecond <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;.%L&quot;</span>)<span class="op">,</span></span>
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true"></a>    formatSecond <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;:%S&quot;</span>)<span class="op">,</span></span>
<span id="cb3-3"><a href="#cb3-3" aria-hidden="true"></a>    formatMinute <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%I:%M&quot;</span>)<span class="op">,</span></span>
<span id="cb3-4"><a href="#cb3-4" aria-hidden="true"></a>    formatHour <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%I %p&quot;</span>)<span class="op">,</span></span>
<span id="cb3-5"><a href="#cb3-5" aria-hidden="true"></a>    formatDay <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%a %d&quot;</span>)<span class="op">,</span></span>
<span id="cb3-6"><a href="#cb3-6" aria-hidden="true"></a>    formatWeek <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%b %d&quot;</span>)<span class="op">,</span></span>
<span id="cb3-7"><a href="#cb3-7" aria-hidden="true"></a>    formatMonth <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%B&quot;</span>)<span class="op">,</span></span>
<span id="cb3-8"><a href="#cb3-8" aria-hidden="true"></a>    formatYear <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%Y&quot;</span>)<span class="op">;</span></span>
<span id="cb3-9"><a href="#cb3-9" aria-hidden="true"></a></span>
<span id="cb3-10"><a href="#cb3-10" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">multiFormat</span>(date) {</span>
<span id="cb3-11"><a href="#cb3-11" aria-hidden="true"></a>  <span class="cf">return</span> (d3<span class="op">.</span><span class="fu">timeSecond</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatMillisecond</span>
<span id="cb3-12"><a href="#cb3-12" aria-hidden="true"></a>      <span class="op">:</span> d3<span class="op">.</span><span class="fu">timeMinute</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatSecond</span>
<span id="cb3-13"><a href="#cb3-13" aria-hidden="true"></a>      <span class="op">:</span> d3<span class="op">.</span><span class="fu">timeHour</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatMinute</span>
<span id="cb3-14"><a href="#cb3-14" aria-hidden="true"></a>      <span class="op">:</span> d3<span class="op">.</span><span class="fu">timeDay</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatHour</span>
<span id="cb3-15"><a href="#cb3-15" aria-hidden="true"></a>      <span class="op">:</span> d3<span class="op">.</span><span class="fu">timeMonth</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> (d3<span class="op">.</span><span class="fu">timeWeek</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatDay <span class="op">:</span> formatWeek)</span>
<span id="cb3-16"><a href="#cb3-16" aria-hidden="true"></a>      <span class="op">:</span> d3<span class="op">.</span><span class="fu">timeYear</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatMonth</span>
<span id="cb3-17"><a href="#cb3-17" aria-hidden="true"></a>      <span class="op">:</span> formatYear)(date)<span class="op">;</span></span>
...
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-time-format.v2.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb4-3"><a href="#cb4-3" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb4-4"><a href="#cb4-4" aria-hidden="true"></a></span>
<span id="cb4-5"><a href="#cb4-5" aria-hidden="true"></a><span class="kw">var</span> format <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%x&quot;</span>)<span class="op">;</span></span>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a>d3<span class="op">.</span><span class="fu">json</span>(<span class="st">&quot;https://unpkg.com/d3-time-format@2/locale/ru-RU.json&quot;</span><span class="op">,</span> <span class="kw">function</span>(error<span class="op">,</span> locale) {</span>
<span id="cb5-2"><a href="#cb5-2" aria-hidden="true"></a>  <span class="cf">if</span> (error) <span class="cf">throw</span> error<span class="op">;</span></span>
<span id="cb5-3"><a href="#cb5-3" aria-hidden="true"></a></span>
<span id="cb5-4"><a href="#cb5-4" aria-hidden="true"></a>  d3<span class="op">.</span><span class="fu">timeFormatDefaultLocale</span>(locale)<span class="op">;</span></span>
<span id="cb5-5"><a href="#cb5-5" aria-hidden="true"></a></span>
<span id="cb5-6"><a href="#cb5-6" aria-hidden="true"></a>  <span class="kw">var</span> format <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%c&quot;</span>)<span class="op">;</span></span>
<span id="cb5-7"><a href="#cb5-7" aria-hidden="true"></a></span>
<span id="cb5-8"><a href="#cb5-8" aria-hidden="true"></a>  <span class="bu">console</span><span class="op">.</span><span class="fu">log</span>(<span class="fu">format</span>(<span class="kw">new</span> <span class="bu">Date</span>))<span class="op">;</span> <span class="co">// понедельник,  5 декабря 2016 г. 10:31:59</span></span>
...
<p><a name="timeFormat" href="#timeFormat">#</a> d3.<b>timeFormat</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/defaultLocale.js#L4" title="Source">&lt;&gt;</a></p>
<p>An alias for <a href="#locale_format"><em>locale</em>.format</a> on the <a href="#timeFormatDefaultLocale">default locale</a>.</p>
<p><a name="timeParse" href="#timeParse">#</a> d3.<b>timeParse</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/defaultLocale.js#L5" title="Source">&lt;&gt;</a></p>
<p>An alias for <a href="#locale_parse"><em>locale</em>.parse</a> on the <a href="#timeFormatDefaultLocale">default locale</a>.</p>
<p><a name="utcFormat" href="#utcFormat">#</a> d3.<b>utcFormat</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/defaultLocale.js#L6" title="Source">&lt;&gt;</a></p>
<p>An alias for <a href="#locale_utcFormat"><em>locale</em>.utcFormat</a> on the <a href="#timeFormatDefaultLocale">default locale</a>.</p>
<p><a name="utcParse" href="#utcParse">#</a> d3.<b>utcParse</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/defaultLocale.js#L7" title="Source">&lt;&gt;</a></p>
<p>An alias for <a href="#locale_utcParse"><em>locale</em>.utcParse</a> on the <a href="#timeFormatDefaultLocale">default locale</a>.</p>
<p><a name="isoFormat" href="#isoFormat">#</a> d3.<b>isoFormat</b> <a href="https://github.com/d3/d3-time-format/blob/master/src/isoFormat.js" title="Source">&lt;&gt;</a></p>
...
<p><a name="isoParse" href="#isoParse">#</a> d3.<b>isoParse</b> <a href="https://github.com/d3/d3-time-format/blob/master/src/isoParse.js" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb6-1"><a href="#cb6-1" aria-hidden="true"></a><span class="kw">var</span> strictIsoParse <span class="op">=</span> d3<span class="op">.</span><span class="fu">utcParse</span>(<span class="st">&quot;%Y-%m-%dT%H:%M:%S.%LZ&quot;</span>)<span class="op">;</span></span></code></pre></div>
<p><a name="locale_format" href="#locale_format">#</a> <i>locale</i>.<b>format</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/locale.js#L293" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="kw">var</span> formatMonth <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%B&quot;</span>)<span class="op">,</span></span>
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true"></a>    formatDay <span class="op">=</span> d3<span class="op">.</span><span class="fu">timeFormat</span>(<span class="st">&quot;%A&quot;</span>)<span class="op">,</span></span>
<span id="cb7-3"><a href="#cb7-3" aria-hidden="true"></a>    date <span class="op">=</span> <span class="kw">new</span> <span class="bu">Date</span>(<span class="dv">2014</span><span class="op">,</span> <span class="dv">4</span><span class="op">,</span> <span class="dv">1</span>)<span class="op">;</span> <span class="co">// Thu May 01 2014 00:00:00 GMT-0700 (PDT)</span></span>
<span id="cb7-4"><a href="#cb7-4" aria-hidden="true"></a></span>
<span id="cb7-5"><a href="#cb7-5" aria-hidden="true"></a><span class="fu">formatMonth</span>(date)<span class="op">;</span> <span class="co">// &quot;May&quot;</span></span>
<span id="cb7-6"><a href="#cb7-6" aria-hidden="true"></a><span class="fu">formatDay</span>(date)<span class="op">;</span> <span class="co">// &quot;Thursday&quot;</span></span></code></pre></div>
<p><a name="locale_parse" href="#locale_parse">#</a> <i>locale</i>.<b>parse</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/locale.js#L298" title="Source">&lt;&gt;</a></p>
...
<p><a name="locale_utcFormat" href="#locale_utcFormat">#</a> <i>locale</i>.<b>utcFormat</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/locale.js#L303" title="Source">&lt;&gt;</a></p>
...
<p><a name="locale_utcParse" href="#locale_utcParse">#</a> <i>locale</i>.<b>utcParse</b>(<i>specifier</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/locale.js#L308" title="Source">&lt;&gt;</a></p>
...
<p><a name="timeFormatLocale" href="#timeFormatLocale">#</a> d3.<b>timeFormatLocale</b>(<i>definition</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/locale.js" title="Source">&lt;&gt;</a></p>
...
<p><a name="timeFormatDefaultLocale" href="#timeFormatDefaultLocale">#</a> d3.<b>timeFormatDefaultLocale</b>(<i>definition</i>) <a href="https://github.com/d3/d3-time-format/blob/master/src/defaultLocale.js" title="Source">&lt;&gt;</a></p>
