...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">var</span> formatTime <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%B %d, %Y&quot;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb1-2" title="2"><span class="at">formatTime</span>(<span class="kw">new</span> Date)<span class="op">;</span> <span class="co">// &quot;June 30, 2015&quot;</span></a></code></pre></div>
<p>Likewise, to convert a string back to a date, create a <a href="#locale_parse">parser</a>:</p>
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> parseTime <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeParse</span>(<span class="st">&quot;%B %d, %Y&quot;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-2" title="2"><span class="at">parseTime</span>(<span class="st">&quot;June 30, 2015&quot;</span>)<span class="op">;</span> <span class="co">// Tue Jun 30 2015 00:00:00 GMT-0700 (PDT)</span></a></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">var</span> formatMillisecond <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;.%L&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-2" title="2">    formatSecond <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;:%S&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-3" title="3">    formatMinute <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%I:%M&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-4" title="4">    formatHour <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%I %p&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-5" title="5">    formatDay <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%a %d&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-6" title="6">    formatWeek <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%b %d&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-7" title="7">    formatMonth <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%B&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb3-8" title="8">    formatYear <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%Y&quot;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb3-9" title="9"></a>
<a class="sourceLine" id="cb3-10" title="10"><span class="kw">function</span> <span class="at">multiFormat</span>(date) <span class="op">{</span></a>
<a class="sourceLine" id="cb3-11" title="11">  <span class="cf">return</span> (<span class="va">d3</span>.<span class="at">timeSecond</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatMillisecond</a>
<a class="sourceLine" id="cb3-12" title="12">      : <span class="va">d3</span>.<span class="at">timeMinute</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatSecond</a>
<a class="sourceLine" id="cb3-13" title="13">      : <span class="va">d3</span>.<span class="at">timeHour</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatMinute</a>
<a class="sourceLine" id="cb3-14" title="14">      : <span class="va">d3</span>.<span class="at">timeDay</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatHour</a>
<a class="sourceLine" id="cb3-15" title="15">      : <span class="va">d3</span>.<span class="at">timeMonth</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> (<span class="va">d3</span>.<span class="at">timeWeek</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatDay : formatWeek)</a>
<a class="sourceLine" id="cb3-16" title="16">      : <span class="va">d3</span>.<span class="at">timeYear</span>(date) <span class="op">&lt;</span> date <span class="op">?</span> formatMonth</a>
<a class="sourceLine" id="cb3-17" title="17">      : formatYear)(date)<span class="op">;</span></a>
...
<a class="sourceLine" id="cb4-2" title="2"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-time-format.v2.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb4-3" title="3"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb4-4" title="4"></a>
<a class="sourceLine" id="cb4-5" title="5"><span class="kw">var</span> format <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%x&quot;</span>)<span class="op">;</span></a>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="va">d3</span>.<span class="at">json</span>(<span class="st">&quot;https://unpkg.com/d3-time-format@2/locale/ru-RU.json&quot;</span><span class="op">,</span> <span class="kw">function</span>(error<span class="op">,</span> locale) <span class="op">{</span></a>
<a class="sourceLine" id="cb5-2" title="2">  <span class="cf">if</span> (error) <span class="cf">throw</span> error<span class="op">;</span></a>
<a class="sourceLine" id="cb5-3" title="3"></a>
<a class="sourceLine" id="cb5-4" title="4">  <span class="va">d3</span>.<span class="at">timeFormatDefaultLocale</span>(locale)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-5" title="5"></a>
<a class="sourceLine" id="cb5-6" title="6">  <span class="kw">var</span> format <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%c&quot;</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb5-7" title="7"></a>
<a class="sourceLine" id="cb5-8" title="8">  <span class="va">console</span>.<span class="at">log</span>(<span class="at">format</span>(<span class="kw">new</span> Date))<span class="op">;</span> <span class="co">// понедельник,  5 декабря 2016 г. 10:31:59</span></a>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="kw">var</span> strictIsoParse <span class="op">=</span> <span class="va">d3</span>.<span class="at">utcParse</span>(<span class="st">&quot;%Y-%m-%dT%H:%M:%S.%LZ&quot;</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">var</span> formatMonth <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%B&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb7-2" title="2">    formatDay <span class="op">=</span> <span class="va">d3</span>.<span class="at">timeFormat</span>(<span class="st">&quot;%A&quot;</span>)<span class="op">,</span></a>
<a class="sourceLine" id="cb7-3" title="3">    date <span class="op">=</span> <span class="kw">new</span> <span class="at">Date</span>(<span class="dv">2014</span><span class="op">,</span> <span class="dv">4</span><span class="op">,</span> <span class="dv">1</span>)<span class="op">;</span> <span class="co">// Thu May 01 2014 00:00:00 GMT-0700 (PDT)</span></a>
<a class="sourceLine" id="cb7-4" title="4"></a>
<a class="sourceLine" id="cb7-5" title="5"><span class="at">formatMonth</span>(date)<span class="op">;</span> <span class="co">// &quot;May&quot;</span></a>
<a class="sourceLine" id="cb7-6" title="6"><span class="at">formatDay</span>(date)<span class="op">;</span> <span class="co">// &quot;Thursday&quot;</span></a></code></pre></div>
