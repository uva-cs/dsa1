...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-quadtree.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-2" title="2"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb1-3" title="3"></a>
<a class="sourceLine" id="cb1-4" title="4"><span class="kw">var</span> quadtree <span class="op">=</span> <span class="va">d3</span>.<span class="at">quadtree</span>()<span class="op">;</span></a>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> tree <span class="op">=</span> <span class="va">d3</span>.<span class="at">quadtree</span>()</a>
<a class="sourceLine" id="cb2-2" title="2">    .<span class="at">addAll</span>(data)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">var</span> tree <span class="op">=</span> <span class="va">d3</span>.<span class="at">quadtree</span>()</a>
<a class="sourceLine" id="cb3-2" title="2">    .<span class="at">x</span>(x)</a>
<a class="sourceLine" id="cb3-3" title="3">    .<span class="at">y</span>(y)</a>
<a class="sourceLine" id="cb3-4" title="4">    .<span class="at">addAll</span>(data)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="kw">function</span> <span class="at">x</span>(d) <span class="op">{</span></a>
<a class="sourceLine" id="cb4-2" title="2">  <span class="cf">return</span> d[<span class="dv">0</span>]<span class="op">;</span></a>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">function</span> <span class="at">y</span>(d) <span class="op">{</span></a>
<a class="sourceLine" id="cb5-2" title="2">  <span class="cf">return</span> d[<span class="dv">1</span>]<span class="op">;</span></a>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="cf">for</span> (<span class="kw">var</span> i <span class="op">=</span> <span class="dv">0</span><span class="op">,</span> n <span class="op">=</span> <span class="va">data</span>.<span class="at">length</span><span class="op">;</span> i <span class="op">&lt;</span> n<span class="op">;</span> <span class="op">++</span>i) <span class="op">{</span></a>
<a class="sourceLine" id="cb6-2" title="2">  <span class="va">quadtree</span>.<span class="at">add</span>(data[i])<span class="op">;</span></a>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="cf">if</span> (<span class="op">!</span><span class="va">node</span>.<span class="at">length</span>) <span class="cf">do</span> <span class="va">console</span>.<span class="at">log</span>(<span class="va">node</span>.<span class="at">data</span>)<span class="op">;</span> <span class="cf">while</span> (node <span class="op">=</span> <span class="va">node</span>.<span class="at">next</span>)<span class="op">;</span></a></code></pre></div>
