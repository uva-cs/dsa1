...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">var</span> i <span class="op">=</span> <span class="va">d3</span>.<span class="at">interpolateNumber</span>(<span class="dv">10</span><span class="op">,</span> <span class="dv">20</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb1-2" title="2"><span class="at">i</span>(<span class="fl">0.0</span>)<span class="op">;</span> <span class="co">// 10</span></a>
<a class="sourceLine" id="cb1-3" title="3"><span class="at">i</span>(<span class="fl">0.2</span>)<span class="op">;</span> <span class="co">// 12</span></a>
<a class="sourceLine" id="cb1-4" title="4"><span class="at">i</span>(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// 15</span></a>
<a class="sourceLine" id="cb1-5" title="5"><span class="at">i</span>(<span class="fl">1.0</span>)<span class="op">;</span> <span class="co">// 20</span></a></code></pre></div>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="va">d3</span>.<span class="at">interpolateLab</span>(<span class="st">&quot;steelblue&quot;</span><span class="op">,</span> <span class="st">&quot;brown&quot;</span>)(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// &quot;rgb(142, 92, 109)&quot;</span></a></code></pre></div>
<p>Here’s a more elaborate example demonstrating type inference used by <a href="#interpolate">interpolate</a>:</p>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">var</span> i <span class="op">=</span> <span class="va">d3</span>.<span class="at">interpolate</span>(<span class="op">{</span><span class="dt">colors</span><span class="op">:</span> [<span class="st">&quot;red&quot;</span><span class="op">,</span> <span class="st">&quot;blue&quot;</span>]<span class="op">},</span> <span class="op">{</span><span class="dt">colors</span><span class="op">:</span> [<span class="st">&quot;white&quot;</span><span class="op">,</span> <span class="st">&quot;black&quot;</span>]<span class="op">}</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb3-2" title="2"><span class="at">i</span>(<span class="fl">0.0</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 0, 0)&quot;, &quot;rgb(0, 0, 255)&quot;]}</span></a>
<a class="sourceLine" id="cb3-3" title="3"><span class="at">i</span>(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 128, 128)&quot;, &quot;rgb(0, 0, 128)&quot;]}</span></a>
<a class="sourceLine" id="cb3-4" title="4"><span class="at">i</span>(<span class="fl">1.0</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 255, 255)&quot;, &quot;rgb(0, 0, 0)&quot;]}</span></a></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode html"><code class="sourceCode html"><a class="sourceLine" id="cb4-1" title="1"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-color.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb4-2" title="2"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-interpolate.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb4-3" title="3"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb4-4" title="4"></a>
<a class="sourceLine" id="cb4-5" title="5"><span class="kw">var</span> interpolate <span class="op">=</span> <span class="va">d3</span>.<span class="at">interpolateRgb</span>(<span class="st">&quot;steelblue&quot;</span><span class="op">,</span> <span class="st">&quot;brown&quot;</span>)<span class="op">;</span></a>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">function</span> <span class="at">interpolator</span>(t) <span class="op">{</span></a>
<a class="sourceLine" id="cb5-2" title="2">  <span class="cf">return</span> a <span class="op">*</span> (<span class="dv">1</span> <span class="op">-</span> t) <span class="op">+</span> b <span class="op">*</span> t<span class="op">;</span></a>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="kw">var</span> interpolator <span class="op">=</span> <span class="va">d3</span>.<span class="va">interpolateRgb</span>.<span class="at">gamma</span>(<span class="fl">2.2</span>)(<span class="st">&quot;purple&quot;</span><span class="op">,</span> <span class="st">&quot;orange&quot;</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">var</span> interpolate <span class="op">=</span> <span class="va">d3</span>.<span class="at">piecewise</span>(<span class="va">d3</span>.<span class="va">interpolateRgb</span>.<span class="at">gamma</span>(<span class="fl">2.2</span>)<span class="op">,</span> [<span class="st">&quot;red&quot;</span><span class="op">,</span> <span class="st">&quot;green&quot;</span><span class="op">,</span> <span class="st">&quot;blue&quot;</span>])<span class="op">;</span></a></code></pre></div>
</body>
</html>
