...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">var</span> i <span class="op">=</span> d3<span class="op">.</span><span class="fu">interpolateNumber</span>(<span class="dv">10</span><span class="op">,</span> <span class="dv">20</span>)<span class="op">;</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">0.0</span>)<span class="op">;</span> <span class="co">// 10</span></span>
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">0.2</span>)<span class="op">;</span> <span class="co">// 12</span></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// 15</span></span>
<span id="cb1-5"><a href="#cb1-5" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">1.0</span>)<span class="op">;</span> <span class="co">// 20</span></span></code></pre></div>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true"></a>d3<span class="op">.</span><span class="fu">interpolateLab</span>(<span class="st">&quot;steelblue&quot;</span><span class="op">,</span> <span class="st">&quot;brown&quot;</span>)(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// &quot;rgb(142, 92, 109)&quot;</span></span></code></pre></div>
<p>Here’s a more elaborate example demonstrating type inference used by <a href="#interpolate">interpolate</a>:</p>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a><span class="kw">var</span> i <span class="op">=</span> d3<span class="op">.</span><span class="fu">interpolate</span>({<span class="dt">colors</span><span class="op">:</span> [<span class="st">&quot;red&quot;</span><span class="op">,</span> <span class="st">&quot;blue&quot;</span>]}<span class="op">,</span> {<span class="dt">colors</span><span class="op">:</span> [<span class="st">&quot;white&quot;</span><span class="op">,</span> <span class="st">&quot;black&quot;</span>]})<span class="op">;</span></span>
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">0.0</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 0, 0)&quot;, &quot;rgb(0, 0, 255)&quot;]}</span></span>
<span id="cb3-3"><a href="#cb3-3" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">0.5</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 128, 128)&quot;, &quot;rgb(0, 0, 128)&quot;]}</span></span>
<span id="cb3-4"><a href="#cb3-4" aria-hidden="true"></a><span class="fu">i</span>(<span class="fl">1.0</span>)<span class="op">;</span> <span class="co">// {colors: [&quot;rgb(255, 255, 255)&quot;, &quot;rgb(0, 0, 0)&quot;]}</span></span></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-color.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-interpolate.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb4-3"><a href="#cb4-3" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb4-4"><a href="#cb4-4" aria-hidden="true"></a></span>
<span id="cb4-5"><a href="#cb4-5" aria-hidden="true"></a><span class="kw">var</span> interpolate <span class="op">=</span> d3<span class="op">.</span><span class="fu">interpolateRgb</span>(<span class="st">&quot;steelblue&quot;</span><span class="op">,</span> <span class="st">&quot;brown&quot;</span>)<span class="op">;</span></span>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">interpolator</span>(t) {</span>
<span id="cb5-2"><a href="#cb5-2" aria-hidden="true"></a>  <span class="cf">return</span> a <span class="op">*</span> (<span class="dv">1</span> <span class="op">-</span> t) <span class="op">+</span> b <span class="op">*</span> t<span class="op">;</span></span>
