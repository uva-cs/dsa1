...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">mercator</span>(x<span class="op">,</span> y) {</span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a>  <span class="cf">return</span> [x<span class="op">,</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">log</span>(<span class="bu">Math</span><span class="op">.</span><span class="fu">tan</span>(<span class="bu">Math</span><span class="op">.</span><span class="cn">PI</span> <span class="op">/</span> <span class="dv">4</span> <span class="op">+</span> y <span class="op">/</span> <span class="dv">2</span>))]<span class="op">;</span></span>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-array.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-geo.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true"></a></span>
<span id="cb2-5"><a href="#cb2-5" aria-hidden="true"></a><span class="kw">var</span> projection <span class="op">=</span> d3<span class="op">.</span><span class="fu">geoNaturalEarth1</span>()<span class="op">,</span></span>
<span id="cb2-6"><a href="#cb2-6" aria-hidden="true"></a>    path <span class="op">=</span> d3<span class="op">.</span><span class="fu">geoPath</span>(projection)<span class="op">;</span></span>
<span id="cb2-7"><a href="#cb2-7" aria-hidden="true"></a></span>
<span id="cb2-8"><a href="#cb2-8" aria-hidden="true"></a><span class="kw">&lt;/script&gt;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a>svg<span class="op">.</span><span class="fu">append</span>(<span class="st">&quot;path&quot;</span>)</span>
<span id="cb3-2"><a href="#cb3-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">datum</span>({<span class="dt">type</span><span class="op">:</span> <span class="st">&quot;FeatureCollection&quot;</span><span class="op">,</span> <span class="dt">features</span><span class="op">:</span> features})</span>
<span id="cb3-3"><a href="#cb3-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">attr</span>(<span class="st">&quot;d&quot;</span><span class="op">,</span> d3<span class="op">.</span><span class="fu">geoPath</span>())<span class="op">;</span></span></code></pre></div>
<p>Or use multiple path elements:</p>
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a>svg<span class="op">.</span><span class="fu">selectAll</span>(<span class="st">&quot;path&quot;</span>)</span>
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true"></a>  <span class="op">.</span><span class="fu">data</span>(features)</span>
<span id="cb4-3"><a href="#cb4-3" aria-hidden="true"></a>  <span class="op">.</span><span class="fu">enter</span>()<span class="op">.</span><span class="fu">append</span>(<span class="st">&quot;path&quot;</span>)</span>
<span id="cb4-4"><a href="#cb4-4" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">attr</span>(<span class="st">&quot;d&quot;</span><span class="op">,</span> d3<span class="op">.</span><span class="fu">geoPath</span>())<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a><span class="kw">var</span> projection <span class="op">=</span> d3<span class="op">.</span><span class="fu">geoTransverseMercator</span>()</span>
<span id="cb5-2"><a href="#cb5-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">rotate</span>([<span class="dv">74</span> <span class="op">+</span> <span class="dv">30</span> <span class="op">/</span> <span class="dv">60</span><span class="op">,</span> <span class="dv">-38</span> <span class="op">-</span> <span class="dv">50</span> <span class="op">/</span> <span class="dv">60</span>])</span>
<span id="cb5-3"><a href="#cb5-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">fitExtent</span>([[<span class="dv">20</span><span class="op">,</span> <span class="dv">20</span>]<span class="op">,</span> [<span class="dv">940</span><span class="op">,</span> <span class="dv">480</span>]]<span class="op">,</span> nj)<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb6-1"><a href="#cb6-1" aria-hidden="true"></a>projection<span class="op">.</span><span class="fu">fitExtent</span>([[<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>]<span class="op">,</span> [width<span class="op">,</span> height]]<span class="op">,</span> object)<span class="op">;</span></span>
<span id="cb6-2"><a href="#cb6-2" aria-hidden="true"></a>projection<span class="op">.</span><span class="fu">fitSize</span>([width<span class="op">,</span> height]<span class="op">,</span> object)<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="kw">var</span> mercator <span class="op">=</span> d3<span class="op">.</span><span class="fu">geoProjection</span>(<span class="kw">function</span>(x<span class="op">,</span> y) {</span>
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true"></a>  <span class="cf">return</span> [x<span class="op">,</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">log</span>(<span class="bu">Math</span><span class="op">.</span><span class="fu">tan</span>(<span class="bu">Math</span><span class="op">.</span><span class="cn">PI</span> <span class="op">/</span> <span class="dv">4</span> <span class="op">+</span> y <span class="op">/</span> <span class="dv">2</span>))]<span class="op">;</span></span>
<span id="cb7-3"><a href="#cb7-3" aria-hidden="true"></a>})<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb8-1"><a href="#cb8-1" aria-hidden="true"></a><span class="co">// y0 and y1 represent two parallels</span></span>
<span id="cb8-2"><a href="#cb8-2" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">conicFactory</span>(phi0<span class="op">,</span> phi1) {</span>
<span id="cb8-3"><a href="#cb8-3" aria-hidden="true"></a>  <span class="cf">return</span> <span class="kw">function</span> <span class="fu">conicRaw</span>(lambda<span class="op">,</span> phi) {</span>
<span id="cb8-4"><a href="#cb8-4" aria-hidden="true"></a>    <span class="cf">return</span> […<span class="op">,</span> …]<span class="op">;</span></span>
<span id="cb8-5"><a href="#cb8-5" aria-hidden="true"></a>  }<span class="op">;</span></span>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb9-1"><a href="#cb9-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">conicCustom</span>() {</span>
<span id="cb9-2"><a href="#cb9-2" aria-hidden="true"></a>  <span class="kw">var</span> phi0 <span class="op">=</span> <span class="fl">29.5</span><span class="op">,</span></span>
<span id="cb9-3"><a href="#cb9-3" aria-hidden="true"></a>      phi1 <span class="op">=</span> <span class="fl">45.5</span><span class="op">,</span></span>
<span id="cb9-4"><a href="#cb9-4" aria-hidden="true"></a>      mutate <span class="op">=</span> d3<span class="op">.</span><span class="fu">geoProjectionMutator</span>(conicFactory)<span class="op">,</span></span>
<span id="cb9-5"><a href="#cb9-5" aria-hidden="true"></a>      projection <span class="op">=</span> <span class="fu">mutate</span>(phi0<span class="op">,</span> phi1)<span class="op">;</span></span>
<span id="cb9-6"><a href="#cb9-6" aria-hidden="true"></a></span>
<span id="cb9-7"><a href="#cb9-7" aria-hidden="true"></a>  projection<span class="op">.</span><span class="at">parallels</span> <span class="op">=</span> <span class="kw">function</span>(_) {</span>
<span id="cb9-8"><a href="#cb9-8" aria-hidden="true"></a>    <span class="cf">return</span> <span class="kw">arguments</span><span class="op">.</span><span class="at">length</span> <span class="op">?</span> <span class="fu">mutate</span>(phi0 <span class="op">=</span> <span class="op">+</span>_[<span class="dv">0</span>]<span class="op">,</span> phi1 <span class="op">=</span> <span class="op">+</span>_[<span class="dv">1</span>]) <span class="op">:</span> [phi0<span class="op">,</span> phi1]<span class="op">;</span></span>
<span id="cb9-9"><a href="#cb9-9" aria-hidden="true"></a>  }<span class="op">;</span></span>
<span id="cb9-10"><a href="#cb9-10" aria-hidden="true"></a></span>
<span id="cb9-11"><a href="#cb9-11" aria-hidden="true"></a>  <span class="cf">return</span> projection<span class="op">;</span></span>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb10-1"><a href="#cb10-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">center</span>() {</span>
<span id="cb10-2"><a href="#cb10-2" aria-hidden="true"></a>  <span class="cf">return</span> [<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>]<span class="op">;</span></span>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb11-1"><a href="#cb11-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">radius</span>() {</span>
<span id="cb11-2"><a href="#cb11-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">90</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb12-1"><a href="#cb12-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">precision</span>() {</span>
<span id="cb12-2"><a href="#cb12-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">6</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb13-1"><a href="#cb13-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">geoGraticule10</span>() {</span>
<span id="cb13-2"><a href="#cb13-2" aria-hidden="true"></a>  <span class="cf">return</span> d3<span class="op">.</span><span class="fu">geoGraticule</span>()()<span class="op">;</span></span>
...
<span id="cb14-2"><a href="#cb14-2" aria-hidden="true"></a>  <span class="dt">&quot;type&quot;</span><span class="fu">:</span> <span class="st">&quot;Polygon&quot;</span><span class="fu">,</span></span>
<span id="cb14-3"><a href="#cb14-3" aria-hidden="true"></a>  <span class="dt">&quot;coordinates&quot;</span><span class="fu">:</span> <span class="ot">[</span></span>
<span id="cb14-4"><a href="#cb14-4" aria-hidden="true"></a>    <span class="ot">[[</span><span class="dv">0</span><span class="ot">,</span> <span class="dv">0</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">0</span><span class="ot">,</span> <span class="dv">1</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">1</span><span class="ot">,</span> <span class="dv">1</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">1</span><span class="ot">,</span> <span class="dv">0</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">0</span><span class="ot">,</span> <span class="dv">0</span><span class="ot">]]</span></span>
<span id="cb14-5"><a href="#cb14-5" aria-hidden="true"></a>  <span class="ot">]</span></span>
<span id="cb14-6"><a href="#cb14-6" aria-hidden="true"></a><span class="fu">}</span></span></code></pre></div>
<p>Will produce the following series of method calls on the stream:</p>
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb15-1"><a href="#cb15-1" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">polygonStart</span>()<span class="op">;</span></span>
<span id="cb15-2"><a href="#cb15-2" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">lineStart</span>()<span class="op">;</span></span>
<span id="cb15-3"><a href="#cb15-3" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">point</span>(<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>)<span class="op">;</span></span>
<span id="cb15-4"><a href="#cb15-4" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">point</span>(<span class="dv">0</span><span class="op">,</span> <span class="dv">1</span>)<span class="op">;</span></span>
<span id="cb15-5"><a href="#cb15-5" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">point</span>(<span class="dv">1</span><span class="op">,</span> <span class="dv">1</span>)<span class="op">;</span></span>
<span id="cb15-6"><a href="#cb15-6" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">point</span>(<span class="dv">1</span><span class="op">,</span> <span class="dv">0</span>)<span class="op">;</span></span>
<span id="cb15-7"><a href="#cb15-7" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">lineEnd</span>()<span class="op">;</span></span>
<span id="cb15-8"><a href="#cb15-8" aria-hidden="true"></a>stream<span class="op">.</span><span class="fu">polygonEnd</span>()<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb16-1"><a href="#cb16-1" aria-hidden="true"></a><span class="kw">var</span> reflectY <span class="op">=</span> d3<span class="op">.</span><span class="fu">geoTransform</span>({</span>
<span id="cb16-2"><a href="#cb16-2" aria-hidden="true"></a>  <span class="dt">point</span><span class="op">:</span> <span class="kw">function</span>(x<span class="op">,</span> y) {</span>
<span id="cb16-3"><a href="#cb16-3" aria-hidden="true"></a>    <span class="kw">this</span><span class="op">.</span><span class="at">stream</span><span class="op">.</span><span class="fu">point</span>(x<span class="op">,</span> <span class="op">-</span>y)<span class="op">;</span></span>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb17-1"><a href="#cb17-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">matrix</span>(a<span class="op">,</span> b<span class="op">,</span> c<span class="op">,</span> d<span class="op">,</span> tx<span class="op">,</span> ty) {</span>
<span id="cb17-2"><a href="#cb17-2" aria-hidden="true"></a>  <span class="cf">return</span> d3<span class="op">.</span><span class="fu">geoTransform</span>({</span>
<span id="cb17-3"><a href="#cb17-3" aria-hidden="true"></a>    <span class="dt">point</span><span class="op">:</span> <span class="kw">function</span>(x<span class="op">,</span> y) {</span>
<span id="cb17-4"><a href="#cb17-4" aria-hidden="true"></a>      <span class="kw">this</span><span class="op">.</span><span class="at">stream</span><span class="op">.</span><span class="fu">point</span>(a <span class="op">*</span> x <span class="op">+</span> b <span class="op">*</span> y <span class="op">+</span> tx<span class="op">,</span> c <span class="op">*</span> x <span class="op">+</span> d <span class="op">*</span> y <span class="op">+</span> ty)<span class="op">;</span></span>
