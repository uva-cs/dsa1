...
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">function</span> <span class="at">mercator</span>(x<span class="op">,</span> y) <span class="op">{</span></a>
<a class="sourceLine" id="cb1-2" title="2">  <span class="cf">return</span> [x<span class="op">,</span> <span class="va">Math</span>.<span class="at">log</span>(<span class="va">Math</span>.<span class="at">tan</span>(<span class="va">Math</span>.<span class="at">PI</span> / <span class="dv">4</span> <span class="op">+</span> y / <span class="dv">2</span>))]<span class="op">;</span></a>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode html"><code class="sourceCode html"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-array.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb2-2" title="2"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-geo.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb2-3" title="3"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb2-4" title="4"></a>
<a class="sourceLine" id="cb2-5" title="5"><span class="kw">var</span> projection <span class="op">=</span> <span class="va">d3</span>.<span class="at">geoNaturalEarth1</span>()<span class="op">,</span></a>
<a class="sourceLine" id="cb2-6" title="6">    path <span class="op">=</span> <span class="va">d3</span>.<span class="at">geoPath</span>(projection)<span class="op">;</span></a>
<a class="sourceLine" id="cb2-7" title="7"></a>
<a class="sourceLine" id="cb2-8" title="8"><span class="kw">&lt;/script&gt;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="va">svg</span>.<span class="at">append</span>(<span class="st">&quot;path&quot;</span>)</a>
<a class="sourceLine" id="cb3-2" title="2">    .<span class="at">datum</span>(<span class="op">{</span><span class="dt">type</span><span class="op">:</span> <span class="st">&quot;FeatureCollection&quot;</span><span class="op">,</span> <span class="dt">features</span><span class="op">:</span> features<span class="op">}</span>)</a>
<a class="sourceLine" id="cb3-3" title="3">    .<span class="at">attr</span>(<span class="st">&quot;d&quot;</span><span class="op">,</span> <span class="va">d3</span>.<span class="at">geoPath</span>())<span class="op">;</span></a></code></pre></div>
<p>Or use multiple path elements:</p>
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="va">svg</span>.<span class="at">selectAll</span>(<span class="st">&quot;path&quot;</span>)</a>
<a class="sourceLine" id="cb4-2" title="2">  .<span class="at">data</span>(features)</a>
<a class="sourceLine" id="cb4-3" title="3">  .<span class="at">enter</span>().<span class="at">append</span>(<span class="st">&quot;path&quot;</span>)</a>
<a class="sourceLine" id="cb4-4" title="4">    .<span class="at">attr</span>(<span class="st">&quot;d&quot;</span><span class="op">,</span> <span class="va">d3</span>.<span class="at">geoPath</span>())<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">var</span> projection <span class="op">=</span> <span class="va">d3</span>.<span class="at">geoTransverseMercator</span>()</a>
<a class="sourceLine" id="cb5-2" title="2">    .<span class="at">rotate</span>([<span class="dv">74</span> <span class="op">+</span> <span class="dv">30</span> / <span class="dv">60</span><span class="op">,</span> <span class="dv">-38</span> <span class="op">-</span> <span class="dv">50</span> / <span class="dv">60</span>])</a>
<a class="sourceLine" id="cb5-3" title="3">    .<span class="at">fitExtent</span>([[<span class="dv">20</span><span class="op">,</span> <span class="dv">20</span>]<span class="op">,</span> [<span class="dv">940</span><span class="op">,</span> <span class="dv">480</span>]]<span class="op">,</span> nj)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="va">projection</span>.<span class="at">fitExtent</span>([[<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>]<span class="op">,</span> [width<span class="op">,</span> height]]<span class="op">,</span> object)<span class="op">;</span></a>
<a class="sourceLine" id="cb6-2" title="2"><span class="va">projection</span>.<span class="at">fitSize</span>([width<span class="op">,</span> height]<span class="op">,</span> object)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">var</span> mercator <span class="op">=</span> <span class="va">d3</span>.<span class="at">geoProjection</span>(<span class="kw">function</span>(x<span class="op">,</span> y) <span class="op">{</span></a>
<a class="sourceLine" id="cb7-2" title="2">  <span class="cf">return</span> [x<span class="op">,</span> <span class="va">Math</span>.<span class="at">log</span>(<span class="va">Math</span>.<span class="at">tan</span>(<span class="va">Math</span>.<span class="at">PI</span> / <span class="dv">4</span> <span class="op">+</span> y / <span class="dv">2</span>))]<span class="op">;</span></a>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb8-1" title="1"><span class="co">// y0 and y1 represent two parallels</span></a>
<a class="sourceLine" id="cb8-2" title="2"><span class="kw">function</span> <span class="at">conicFactory</span>(phi0<span class="op">,</span> phi1) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-3" title="3">  <span class="cf">return</span> <span class="kw">function</span> <span class="at">conicRaw</span>(lambda<span class="op">,</span> phi) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-4" title="4">    <span class="cf">return</span> […<span class="op">,</span> …]<span class="op">;</span></a>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb9-1" title="1"><span class="kw">function</span> <span class="at">conicCustom</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb9-2" title="2">  <span class="kw">var</span> phi0 <span class="op">=</span> <span class="fl">29.5</span><span class="op">,</span></a>
<a class="sourceLine" id="cb9-3" title="3">      phi1 <span class="op">=</span> <span class="fl">45.5</span><span class="op">,</span></a>
<a class="sourceLine" id="cb9-4" title="4">      mutate <span class="op">=</span> <span class="va">d3</span>.<span class="at">geoProjectionMutator</span>(conicFactory)<span class="op">,</span></a>
<a class="sourceLine" id="cb9-5" title="5">      projection <span class="op">=</span> <span class="at">mutate</span>(phi0<span class="op">,</span> phi1)<span class="op">;</span></a>
<a class="sourceLine" id="cb9-6" title="6"></a>
<a class="sourceLine" id="cb9-7" title="7">  <span class="va">projection</span>.<span class="at">parallels</span> <span class="op">=</span> <span class="kw">function</span>(_) <span class="op">{</span></a>
<a class="sourceLine" id="cb9-8" title="8">    <span class="cf">return</span> <span class="kw">arguments</span>.<span class="at">length</span> <span class="op">?</span> <span class="at">mutate</span>(phi0 <span class="op">=</span> <span class="op">+</span>_[<span class="dv">0</span>]<span class="op">,</span> phi1 <span class="op">=</span> <span class="op">+</span>_[<span class="dv">1</span>]) : [phi0<span class="op">,</span> phi1]<span class="op">;</span></a>
<a class="sourceLine" id="cb9-9" title="9">  <span class="op">};</span></a>
<a class="sourceLine" id="cb9-10" title="10"></a>
<a class="sourceLine" id="cb9-11" title="11">  <span class="cf">return</span> projection<span class="op">;</span></a>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb10-1" title="1"><span class="kw">function</span> <span class="at">center</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb10-2" title="2">  <span class="cf">return</span> [<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>]<span class="op">;</span></a>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb11-1" title="1"><span class="kw">function</span> <span class="at">radius</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb11-2" title="2">  <span class="cf">return</span> <span class="dv">90</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb12-1" title="1"><span class="kw">function</span> <span class="at">precision</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb12-2" title="2">  <span class="cf">return</span> <span class="dv">6</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb13-1" title="1"><span class="kw">function</span> <span class="at">geoGraticule10</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb13-2" title="2">  <span class="cf">return</span> <span class="va">d3</span>.<span class="at">geoGraticule</span>()()<span class="op">;</span></a>
...
<a class="sourceLine" id="cb14-2" title="2">  <span class="dt">&quot;type&quot;</span><span class="fu">:</span> <span class="st">&quot;Polygon&quot;</span><span class="fu">,</span></a>
<a class="sourceLine" id="cb14-3" title="3">  <span class="dt">&quot;coordinates&quot;</span><span class="fu">:</span> <span class="ot">[</span></a>
<a class="sourceLine" id="cb14-4" title="4">    <span class="ot">[[</span><span class="dv">0</span><span class="ot">,</span> <span class="dv">0</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">0</span><span class="ot">,</span> <span class="dv">1</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">1</span><span class="ot">,</span> <span class="dv">1</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">1</span><span class="ot">,</span> <span class="dv">0</span><span class="ot">],</span> <span class="ot">[</span><span class="dv">0</span><span class="ot">,</span> <span class="dv">0</span><span class="ot">]]</span></a>
...
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb15-1" title="1"><span class="va">stream</span>.<span class="at">polygonStart</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb15-2" title="2"><span class="va">stream</span>.<span class="at">lineStart</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb15-3" title="3"><span class="va">stream</span>.<span class="at">point</span>(<span class="dv">0</span><span class="op">,</span> <span class="dv">0</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb15-4" title="4"><span class="va">stream</span>.<span class="at">point</span>(<span class="dv">0</span><span class="op">,</span> <span class="dv">1</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb15-5" title="5"><span class="va">stream</span>.<span class="at">point</span>(<span class="dv">1</span><span class="op">,</span> <span class="dv">1</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb15-6" title="6"><span class="va">stream</span>.<span class="at">point</span>(<span class="dv">1</span><span class="op">,</span> <span class="dv">0</span>)<span class="op">;</span></a>
<a class="sourceLine" id="cb15-7" title="7"><span class="va">stream</span>.<span class="at">lineEnd</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb15-8" title="8"><span class="va">stream</span>.<span class="at">polygonEnd</span>()<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb16-1" title="1"><span class="kw">var</span> reflectY <span class="op">=</span> <span class="va">d3</span>.<span class="at">geoTransform</span>(<span class="op">{</span></a>
<a class="sourceLine" id="cb16-2" title="2">  <span class="dt">point</span><span class="op">:</span> <span class="kw">function</span>(x<span class="op">,</span> y) <span class="op">{</span></a>
<a class="sourceLine" id="cb16-3" title="3">    <span class="kw">this</span>.<span class="va">stream</span>.<span class="at">point</span>(x<span class="op">,</span> <span class="op">-</span>y)<span class="op">;</span></a>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb17-1" title="1"><span class="kw">function</span> <span class="at">matrix</span>(a<span class="op">,</span> b<span class="op">,</span> c<span class="op">,</span> d<span class="op">,</span> tx<span class="op">,</span> ty) <span class="op">{</span></a>
<a class="sourceLine" id="cb17-2" title="2">  <span class="cf">return</span> <span class="va">d3</span>.<span class="at">geoTransform</span>(<span class="op">{</span></a>
<a class="sourceLine" id="cb17-3" title="3">    <span class="dt">point</span><span class="op">:</span> <span class="kw">function</span>(x<span class="op">,</span> y) <span class="op">{</span></a>
<a class="sourceLine" id="cb17-4" title="4">      <span class="kw">this</span>.<span class="va">stream</span>.<span class="at">point</span>(a <span class="op">*</span> x <span class="op">+</span> b <span class="op">*</span> y <span class="op">+</span> tx<span class="op">,</span> c <span class="op">*</span> x <span class="op">+</span> d <span class="op">*</span> y <span class="op">+</span> ty)<span class="op">;</span></a>
