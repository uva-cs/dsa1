...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-collection.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
...
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-quadtree.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-timer.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-5"><a href="#cb1-5" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-force.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-6"><a href="#cb1-6" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb1-7"><a href="#cb1-7" aria-hidden="true"></a></span>
<span id="cb1-8"><a href="#cb1-8" aria-hidden="true"></a><span class="kw">var</span> simulation <span class="op">=</span> d3<span class="op">.</span><span class="fu">forceSimulation</span>(nodes)<span class="op">;</span></span>
<span id="cb1-9"><a href="#cb1-9" aria-hidden="true"></a></span>
<span id="cb1-10"><a href="#cb1-10" aria-hidden="true"></a><span class="kw">&lt;/script&gt;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb2-1"><a href="#cb2-1" aria-hidden="true"></a><span class="kw">var</span> simulation <span class="op">=</span> d3<span class="op">.</span><span class="fu">forceSimulation</span>(nodes)</span>
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">force</span>(<span class="st">&quot;charge&quot;</span><span class="op">,</span> d3<span class="op">.</span><span class="fu">forceManyBody</span>())</span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">force</span>(<span class="st">&quot;link&quot;</span><span class="op">,</span> d3<span class="op">.</span><span class="fu">forceLink</span>(links))</span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">force</span>(<span class="st">&quot;center&quot;</span><span class="op">,</span> d3<span class="op">.</span><span class="fu">forceCenter</span>())<span class="op">;</span></span></code></pre></div>
<p>To remove the force with the given <em>name</em>, pass null as the <em>force</em>. For example, to remove the charge force:</p>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a>simulation<span class="op">.</span><span class="fu">force</span>(<span class="st">&quot;charge&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">force</span>(alpha) {</span>
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true"></a>  <span class="cf">for</span> (<span class="kw">var</span> i <span class="op">=</span> <span class="dv">0</span><span class="op">,</span> n <span class="op">=</span> nodes<span class="op">.</span><span class="at">length</span><span class="op">,</span> node<span class="op">,</span> k <span class="op">=</span> alpha <span class="op">*</span> <span class="fl">0.1</span><span class="op">;</span> i <span class="op">&lt;</span> n<span class="op">;</span> <span class="op">++</span>i) {</span>
<span id="cb4-3"><a href="#cb4-3" aria-hidden="true"></a>    node <span class="op">=</span> nodes[i]<span class="op">;</span></span>
<span id="cb4-4"><a href="#cb4-4" aria-hidden="true"></a>    node<span class="op">.</span><span class="at">vx</span> <span class="op">-=</span> node<span class="op">.</span><span class="at">x</span> <span class="op">*</span> k<span class="op">;</span></span>
<span id="cb4-5"><a href="#cb4-5" aria-hidden="true"></a>    node<span class="op">.</span><span class="at">vy</span> <span class="op">-=</span> node<span class="op">.</span><span class="at">y</span> <span class="op">*</span> k<span class="op">;</span></span>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">radius</span>() {</span>
<span id="cb5-2"><a href="#cb5-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">1</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb6-1"><a href="#cb6-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">id</span>(d) {</span>
<span id="cb6-2"><a href="#cb6-2" aria-hidden="true"></a>  <span class="cf">return</span> d<span class="op">.</span><span class="at">index</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="kw">var</span> nodes <span class="op">=</span> [</span>
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true"></a>  {<span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Alice&quot;</span>}<span class="op">,</span></span>
<span id="cb7-3"><a href="#cb7-3" aria-hidden="true"></a>  {<span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span>}<span class="op">,</span></span>
<span id="cb7-4"><a href="#cb7-4" aria-hidden="true"></a>  {<span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Carol&quot;</span>}</span>
<span id="cb7-5"><a href="#cb7-5" aria-hidden="true"></a>]<span class="op">;</span></span>
<span id="cb7-6"><a href="#cb7-6" aria-hidden="true"></a></span>
<span id="cb7-7"><a href="#cb7-7" aria-hidden="true"></a><span class="kw">var</span> links <span class="op">=</span> [</span>
<span id="cb7-8"><a href="#cb7-8" aria-hidden="true"></a>  {<span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="dv">0</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="dv">1</span>}<span class="op">,</span> <span class="co">// Alice → Bob</span></span>
<span id="cb7-9"><a href="#cb7-9" aria-hidden="true"></a>  {<span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="dv">2</span>} <span class="co">// Bob → Carol</span></span>
<span id="cb7-10"><a href="#cb7-10" aria-hidden="true"></a>]<span class="op">;</span></span></code></pre></div>
<p>Now consider a different id accessor that returns a string:</p>
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb8-1"><a href="#cb8-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">id</span>(d) {</span>
<span id="cb8-2"><a href="#cb8-2" aria-hidden="true"></a>  <span class="cf">return</span> d<span class="op">.</span><span class="at">id</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb9-1"><a href="#cb9-1" aria-hidden="true"></a><span class="kw">var</span> nodes <span class="op">=</span> [</span>
<span id="cb9-2"><a href="#cb9-2" aria-hidden="true"></a>  {<span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Alice&quot;</span>}<span class="op">,</span></span>
<span id="cb9-3"><a href="#cb9-3" aria-hidden="true"></a>  {<span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span>}<span class="op">,</span></span>
<span id="cb9-4"><a href="#cb9-4" aria-hidden="true"></a>  {<span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Carol&quot;</span>}</span>
<span id="cb9-5"><a href="#cb9-5" aria-hidden="true"></a>]<span class="op">;</span></span>
<span id="cb9-6"><a href="#cb9-6" aria-hidden="true"></a></span>
<span id="cb9-7"><a href="#cb9-7" aria-hidden="true"></a><span class="kw">var</span> links <span class="op">=</span> [</span>
<span id="cb9-8"><a href="#cb9-8" aria-hidden="true"></a>  {<span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="st">&quot;Alice&quot;</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span>}<span class="op">,</span></span>
<span id="cb9-9"><a href="#cb9-9" aria-hidden="true"></a>  {<span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="st">&quot;Carol&quot;</span>}</span>
<span id="cb9-10"><a href="#cb9-10" aria-hidden="true"></a>]<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb10-1"><a href="#cb10-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">distance</span>() {</span>
<span id="cb10-2"><a href="#cb10-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">30</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb11-1"><a href="#cb11-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">strength</span>(link) {</span>
<span id="cb11-2"><a href="#cb11-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">1</span> <span class="op">/</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">min</span>(<span class="fu">count</span>(link<span class="op">.</span><span class="at">source</span>)<span class="op">,</span> <span class="fu">count</span>(link<span class="op">.</span><span class="at">target</span>))<span class="op">;</span></span>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb12-1"><a href="#cb12-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">strength</span>() {</span>
<span id="cb12-2"><a href="#cb12-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">-30</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb13-1"><a href="#cb13-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">strength</span>() {</span>
<span id="cb13-2"><a href="#cb13-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="fl">0.1</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb14"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb14-1"><a href="#cb14-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">x</span>() {</span>
<span id="cb14-2"><a href="#cb14-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">0</span><span class="op">;</span></span>
...
<p>If <em>strength</em> is not specified, returns the current strength accessor, which defaults to:</p>
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb15-1"><a href="#cb15-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">strength</span>() {</span>
<span id="cb15-2"><a href="#cb15-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="fl">0.1</span><span class="op">;</span></span>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb16-1"><a href="#cb16-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">y</span>() {</span>
<span id="cb16-2"><a href="#cb16-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="dv">0</span><span class="op">;</span></span>
...
<p>If <em>strength</em> is not specified, returns the current strength accessor, which defaults to:</p>
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb17-1"><a href="#cb17-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">strength</span>() {</span>
<span id="cb17-2"><a href="#cb17-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="fl">0.1</span><span class="op">;</span></span>
