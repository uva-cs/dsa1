...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><a class="sourceLine" id="cb1-1" title="1"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-collection.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
...
<a class="sourceLine" id="cb1-3" title="3"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-quadtree.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-4" title="4"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-timer.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-5" title="5"><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-force.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></a>
<a class="sourceLine" id="cb1-6" title="6"><span class="kw">&lt;script&gt;</span></a>
<a class="sourceLine" id="cb1-7" title="7"></a>
<a class="sourceLine" id="cb1-8" title="8"><span class="kw">var</span> simulation <span class="op">=</span> <span class="va">d3</span>.<span class="at">forceSimulation</span>(nodes)<span class="op">;</span></a>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">var</span> simulation <span class="op">=</span> <span class="va">d3</span>.<span class="at">forceSimulation</span>(nodes)</a>
<a class="sourceLine" id="cb2-2" title="2">    .<span class="at">force</span>(<span class="st">&quot;charge&quot;</span><span class="op">,</span> <span class="va">d3</span>.<span class="at">forceManyBody</span>())</a>
<a class="sourceLine" id="cb2-3" title="3">    .<span class="at">force</span>(<span class="st">&quot;link&quot;</span><span class="op">,</span> <span class="va">d3</span>.<span class="at">forceLink</span>(links))</a>
<a class="sourceLine" id="cb2-4" title="4">    .<span class="at">force</span>(<span class="st">&quot;center&quot;</span><span class="op">,</span> <span class="va">d3</span>.<span class="at">forceCenter</span>())<span class="op">;</span></a></code></pre></div>
<p>To remove the force with the given <em>name</em>, pass null as the <em>force</em>. For example, to remove the charge force:</p>
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb3-1" title="1"><span class="va">simulation</span>.<span class="at">force</span>(<span class="st">&quot;charge&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></a></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb4-1" title="1"><span class="kw">function</span> <span class="at">force</span>(alpha) <span class="op">{</span></a>
<a class="sourceLine" id="cb4-2" title="2">  <span class="cf">for</span> (<span class="kw">var</span> i <span class="op">=</span> <span class="dv">0</span><span class="op">,</span> n <span class="op">=</span> <span class="va">nodes</span>.<span class="at">length</span><span class="op">,</span> node<span class="op">,</span> k <span class="op">=</span> alpha <span class="op">*</span> <span class="fl">0.1</span><span class="op">;</span> i <span class="op">&lt;</span> n<span class="op">;</span> <span class="op">++</span>i) <span class="op">{</span></a>
<a class="sourceLine" id="cb4-3" title="3">    node <span class="op">=</span> nodes[i]<span class="op">;</span></a>
<a class="sourceLine" id="cb4-4" title="4">    <span class="va">node</span>.<span class="at">vx</span> <span class="op">-=</span> <span class="va">node</span>.<span class="at">x</span> <span class="op">*</span> k<span class="op">;</span></a>
<a class="sourceLine" id="cb4-5" title="5">    <span class="va">node</span>.<span class="at">vy</span> <span class="op">-=</span> <span class="va">node</span>.<span class="at">y</span> <span class="op">*</span> k<span class="op">;</span></a>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb5-1" title="1"><span class="kw">function</span> <span class="at">radius</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb5-2" title="2">  <span class="cf">return</span> <span class="dv">1</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb6-1" title="1"><span class="kw">function</span> <span class="at">id</span>(d) <span class="op">{</span></a>
<a class="sourceLine" id="cb6-2" title="2">  <span class="cf">return</span> <span class="va">d</span>.<span class="at">index</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb7-1" title="1"><span class="kw">var</span> nodes <span class="op">=</span> [</a>
<a class="sourceLine" id="cb7-2" title="2">  <span class="op">{</span><span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Alice&quot;</span><span class="op">},</span></a>
<a class="sourceLine" id="cb7-3" title="3">  <span class="op">{</span><span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span><span class="op">},</span></a>
<a class="sourceLine" id="cb7-4" title="4">  <span class="op">{</span><span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Carol&quot;</span><span class="op">}</span></a>
<a class="sourceLine" id="cb7-5" title="5">]<span class="op">;</span></a>
<a class="sourceLine" id="cb7-6" title="6"></a>
<a class="sourceLine" id="cb7-7" title="7"><span class="kw">var</span> links <span class="op">=</span> [</a>
<a class="sourceLine" id="cb7-8" title="8">  <span class="op">{</span><span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="dv">0</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="dv">1</span><span class="op">},</span> <span class="co">// Alice → Bob</span></a>
<a class="sourceLine" id="cb7-9" title="9">  <span class="op">{</span><span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="dv">1</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="dv">2</span><span class="op">}</span> <span class="co">// Bob → Carol</span></a>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb8-1" title="1"><span class="kw">function</span> <span class="at">id</span>(d) <span class="op">{</span></a>
<a class="sourceLine" id="cb8-2" title="2">  <span class="cf">return</span> <span class="va">d</span>.<span class="at">id</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb9-1" title="1"><span class="kw">var</span> nodes <span class="op">=</span> [</a>
<a class="sourceLine" id="cb9-2" title="2">  <span class="op">{</span><span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Alice&quot;</span><span class="op">},</span></a>
<a class="sourceLine" id="cb9-3" title="3">  <span class="op">{</span><span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span><span class="op">},</span></a>
<a class="sourceLine" id="cb9-4" title="4">  <span class="op">{</span><span class="st">&quot;id&quot;</span><span class="op">:</span> <span class="st">&quot;Carol&quot;</span><span class="op">}</span></a>
<a class="sourceLine" id="cb9-5" title="5">]<span class="op">;</span></a>
<a class="sourceLine" id="cb9-6" title="6"></a>
<a class="sourceLine" id="cb9-7" title="7"><span class="kw">var</span> links <span class="op">=</span> [</a>
<a class="sourceLine" id="cb9-8" title="8">  <span class="op">{</span><span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="st">&quot;Alice&quot;</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span><span class="op">},</span></a>
<a class="sourceLine" id="cb9-9" title="9">  <span class="op">{</span><span class="st">&quot;source&quot;</span><span class="op">:</span> <span class="st">&quot;Bob&quot;</span><span class="op">,</span> <span class="st">&quot;target&quot;</span><span class="op">:</span> <span class="st">&quot;Carol&quot;</span><span class="op">}</span></a>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb10-1" title="1"><span class="kw">function</span> <span class="at">distance</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb10-2" title="2">  <span class="cf">return</span> <span class="dv">30</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb11-1" title="1"><span class="kw">function</span> <span class="at">strength</span>(link) <span class="op">{</span></a>
<a class="sourceLine" id="cb11-2" title="2">  <span class="cf">return</span> <span class="dv">1</span> / <span class="va">Math</span>.<span class="at">min</span>(<span class="at">count</span>(<span class="va">link</span>.<span class="at">source</span>)<span class="op">,</span> <span class="at">count</span>(<span class="va">link</span>.<span class="at">target</span>))<span class="op">;</span></a>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb12-1" title="1"><span class="kw">function</span> <span class="at">strength</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb12-2" title="2">  <span class="cf">return</span> <span class="dv">-30</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb13-1" title="1"><span class="kw">function</span> <span class="at">strength</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb13-2" title="2">  <span class="cf">return</span> <span class="fl">0.1</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb14"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb14-1" title="1"><span class="kw">function</span> <span class="at">x</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb14-2" title="2">  <span class="cf">return</span> <span class="dv">0</span><span class="op">;</span></a>
...
<p>If <em>strength</em> is not specified, returns the current strength accessor, which defaults to:</p>
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb15-1" title="1"><span class="kw">function</span> <span class="at">strength</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb15-2" title="2">  <span class="cf">return</span> <span class="fl">0.1</span><span class="op">;</span></a>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb16-1" title="1"><span class="kw">function</span> <span class="at">y</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb16-2" title="2">  <span class="cf">return</span> <span class="dv">0</span><span class="op">;</span></a>
...
<p>If <em>strength</em> is not specified, returns the current strength accessor, which defaults to:</p>
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb17-1" title="1"><span class="kw">function</span> <span class="at">strength</span>() <span class="op">{</span></a>
<a class="sourceLine" id="cb17-2" title="2">  <span class="cf">return</span> <span class="fl">0.1</span><span class="op">;</span></a>
