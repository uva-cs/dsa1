...
<p><a href="https://bl.ocks.org/mbostock/db6b4335bf1662b413e7968910104f0f"><img alt="Axis Zooming" src="https://raw.githubusercontent.com/d3/d3-zoom/master/img/axis.png" width="420" height="219"></a></p>
...
<p><a href="https://bl.ocks.org/mbostock/b783fbb2e673561d214e09c7fb5cedee"><img alt="Zoom Transitions" src="https://raw.githubusercontent.com/d3/d3-zoom/master/img/transition.png" width="420" height="219"></a></p>
...
<div class="sourceCode" id="cb1"><pre class="sourceCode html"><code class="sourceCode html"><span id="cb1-1"><a href="#cb1-1" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-color.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-2"><a href="#cb1-2" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-dispatch.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-ease.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-interpolate.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-5"><a href="#cb1-5" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-selection.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-6"><a href="#cb1-6" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-timer.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-7"><a href="#cb1-7" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-transition.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-8"><a href="#cb1-8" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-drag.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-9"><a href="#cb1-9" aria-hidden="true"></a><span class="kw">&lt;script</span><span class="ot"> src=</span><span class="st">&quot;https://d3js.org/d3-zoom.v1.min.js&quot;</span><span class="kw">&gt;&lt;/script&gt;</span></span>
<span id="cb1-10"><a href="#cb1-10" aria-hidden="true"></a><span class="kw">&lt;script&gt;</span></span>
<span id="cb1-11"><a href="#cb1-11" aria-hidden="true"></a></span>
<span id="cb1-12"><a href="#cb1-12" aria-hidden="true"></a><span class="kw">var</span> zoom <span class="op">=</span> d3<span class="op">.</span><span class="fu">zoom</span>()<span class="op">;</span></span>
<span id="cb1-13"><a href="#cb1-13" aria-hidden="true"></a></span>
<span id="cb1-14"><a href="#cb1-14" aria-hidden="true"></a><span class="kw">&lt;/script&gt;</span></span></code></pre></div>
...
<p>¹ Necessary to capture events outside an iframe; see <a href="https://github.com/d3/d3-drag/issues/9">d3-drag#9</a>. <br>² Only applies during an active, mouse-based gesture; see <a href="https://github.com/d3/d3-drag/issues/9">d3-drag#9</a>. <br>³ Only applies immediately after some mouse-based gestures; see <a href="#zoom_clickDistance"><em>zoom</em>.clickDistance</a>. <br>⁴ Necessary to allow <a href="https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/HandlingEvents/HandlingEvents.html#//apple_ref/doc/uid/TP40006511-SW7">click emulation</a> on touch input; see <a href="https://github.com/d3/d3-drag/issues/9">d3-drag#9</a>. <br>⁵ Ignored if within 500ms of a touch gesture ending; assumes <a href="https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/HandlingEvents/HandlingEvents.html#//apple_ref/doc/uid/TP40006511-SW7">click emulation</a>. <br>⁶ Double-click and double-tap initiate a transition that emits start, zoom and end events. <br>⁷ The first wheel event emits a start event; an end event is emitted when no wheel events are received for 150ms. <br>⁸ Ignored if already at the corresponding limit of the <a href="#zoom_scaleExtent">scale extent</a>.</p>
<p><a href="#zoom" name="zoom">#</a> d3.<b>zoom</b>() <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js" title="Source">&lt;&gt;</a></p>
...
<p><a href="#_zoom" name="_zoom">#</a> <i>zoom</i>(<i>selection</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L62" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb3-1"><a href="#cb3-1" aria-hidden="true"></a>selection<span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;.zoom&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb4-1"><a href="#cb4-1" aria-hidden="true"></a>selection</span>
<span id="cb4-2"><a href="#cb4-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">call</span>(zoom)</span>
<span id="cb4-3"><a href="#cb4-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;wheel.zoom&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></span></code></pre></div>
...
<p><a href="#zoom_transform" name="zoom_transform">#</a> <i>zoom</i>.<b>transform</b>(<i>selection</i>, <i>transform</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L76" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb5"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb5-1"><a href="#cb5-1" aria-hidden="true"></a>selection<span class="op">.</span><span class="fu">call</span>(zoom<span class="op">.</span><span class="at">transform</span><span class="op">,</span> d3<span class="op">.</span><span class="at">zoomIdentity</span>)<span class="op">;</span></span></code></pre></div>
<p>To smoothly reset the zoom transform to the identity transform over 750 milliseconds:</p>
<div class="sourceCode" id="cb6"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb6-1"><a href="#cb6-1" aria-hidden="true"></a>selection<span class="op">.</span><span class="fu">transition</span>()<span class="op">.</span><span class="fu">duration</span>(<span class="dv">750</span>)<span class="op">.</span><span class="fu">call</span>(zoom<span class="op">.</span><span class="at">transform</span><span class="op">,</span> d3<span class="op">.</span><span class="at">zoomIdentity</span>)<span class="op">;</span></span></code></pre></div>
...
<p><a href="#zoom_translateBy" name="zoom_translateBy">#</a> <i>zoom</i>.<b>translateBy</b>(<i>selection</i>, <i>x</i>, <i>y</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L110" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_translateTo" name="zoom_translateTo">#</a> <i>zoom</i>.<b>translateTo</b>(<i>selection</i>, <i>x</i>, <i>y</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L119" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_scaleBy" name="zoom_scaleBy">#</a> <i>zoom</i>.<b>scaleBy</b>(<i>selection</i>, <i>k</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L91" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_scaleTo" name="zoom_scaleTo">#</a> <i>zoom</i>.<b>scaleTo</b>(<i>selection</i>, <i>k</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L99" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_constrain" name="zoom_constrain">#</a> <i>zoom</i>.<b>constrain</b>([<i>constrain</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#403" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb7-1"><a href="#cb7-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">constrain</span>(transform<span class="op">,</span> extent<span class="op">,</span> translateExtent) {</span>
<span id="cb7-2"><a href="#cb7-2" aria-hidden="true"></a>  <span class="kw">var</span> dx0 <span class="op">=</span> transform<span class="op">.</span><span class="fu">invertX</span>(extent[<span class="dv">0</span>][<span class="dv">0</span>]) <span class="op">-</span> translateExtent[<span class="dv">0</span>][<span class="dv">0</span>]<span class="op">,</span></span>
<span id="cb7-3"><a href="#cb7-3" aria-hidden="true"></a>      dx1 <span class="op">=</span> transform<span class="op">.</span><span class="fu">invertX</span>(extent[<span class="dv">1</span>][<span class="dv">0</span>]) <span class="op">-</span> translateExtent[<span class="dv">1</span>][<span class="dv">0</span>]<span class="op">,</span></span>
<span id="cb7-4"><a href="#cb7-4" aria-hidden="true"></a>      dy0 <span class="op">=</span> transform<span class="op">.</span><span class="fu">invertY</span>(extent[<span class="dv">0</span>][<span class="dv">1</span>]) <span class="op">-</span> translateExtent[<span class="dv">0</span>][<span class="dv">1</span>]<span class="op">,</span></span>
<span id="cb7-5"><a href="#cb7-5" aria-hidden="true"></a>      dy1 <span class="op">=</span> transform<span class="op">.</span><span class="fu">invertY</span>(extent[<span class="dv">1</span>][<span class="dv">1</span>]) <span class="op">-</span> translateExtent[<span class="dv">1</span>][<span class="dv">1</span>]<span class="op">;</span></span>
<span id="cb7-6"><a href="#cb7-6" aria-hidden="true"></a>  <span class="cf">return</span> transform<span class="op">.</span><span class="fu">translate</span>(</span>
<span id="cb7-7"><a href="#cb7-7" aria-hidden="true"></a>    dx1 <span class="op">&gt;</span> dx0 <span class="op">?</span> (dx0 <span class="op">+</span> dx1) <span class="op">/</span> <span class="dv">2</span> <span class="op">:</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">min</span>(<span class="dv">0</span><span class="op">,</span> dx0) <span class="op">||</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">max</span>(<span class="dv">0</span><span class="op">,</span> dx1)<span class="op">,</span></span>
<span id="cb7-8"><a href="#cb7-8" aria-hidden="true"></a>    dy1 <span class="op">&gt;</span> dy0 <span class="op">?</span> (dy0 <span class="op">+</span> dy1) <span class="op">/</span> <span class="dv">2</span> <span class="op">:</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">min</span>(<span class="dv">0</span><span class="op">,</span> dy0) <span class="op">||</span> <span class="bu">Math</span><span class="op">.</span><span class="fu">max</span>(<span class="dv">0</span><span class="op">,</span> dy1)</span>
...
<p><a href="#zoom_filter" name="zoom_filter">#</a> <i>zoom</i>.<b>filter</b>([<i>filter</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L386" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb8"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb8-1"><a href="#cb8-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">filter</span>() {</span>
<span id="cb8-2"><a href="#cb8-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="op">!</span>d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">button</span><span class="op">;</span></span>
...
<p><a href="#zoom_touchable" name="zoom_touchable">#</a> <i>zoom</i>.<b>touchable</b>([<i>touchable</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L390" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb9"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb9-1"><a href="#cb9-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">touchable</span>() {</span>
<span id="cb9-2"><a href="#cb9-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="st">&quot;ontouchstart&quot;</span> <span class="kw">in</span> <span class="kw">this</span><span class="op">;</span></span>
...
<p><a href="#zoom_wheelDelta" name="zoom_wheelDelta">#</a> <i>zoom</i>.<b>wheelDelta</b>([<i>delta</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L382" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb10"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb10-1"><a href="#cb10-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">wheelDelta</span>() {</span>
<span id="cb10-2"><a href="#cb10-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="op">-</span>d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">deltaY</span> <span class="op">*</span> (d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="at">deltaMode</span> <span class="op">?</span> <span class="dv">120</span> <span class="op">:</span> <span class="dv">1</span>) <span class="op">/</span> <span class="dv">500</span><span class="op">;</span></span>
...
<p><a href="#zoom_extent" name="zoom_extent">#</a> <i>zoom</i>.<b>extent</b>([<i>extent</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L394" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_scaleExtent" name="zoom_scaleExtent">#</a> <i>zoom</i>.<b>scaleExtent</b>([<i>extent</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L398" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb11-1"><a href="#cb11-1" aria-hidden="true"></a>selection</span>
<span id="cb11-2"><a href="#cb11-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">call</span>(zoom)</span>
<span id="cb11-3"><a href="#cb11-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;wheel&quot;</span><span class="op">,</span> <span class="kw">function</span>() { d3<span class="op">.</span><span class="at">event</span><span class="op">.</span><span class="fu">preventDefault</span>()<span class="op">;</span> })<span class="op">;</span></span></code></pre></div>
<p><a href="#zoom_translateExtent" name="zoom_translateExtent">#</a> <i>zoom</i>.<b>translateExtent</b>([<i>extent</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L402" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_clickDistance" name="zoom_clickDistance">#</a> <i>zoom</i>.<b>clickDistance</b>([<i>distance</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L419" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_duration" name="zoom_duration">#</a> <i>zoom</i>.<b>duration</b>([<i>duration</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L406" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb12-1"><a href="#cb12-1" aria-hidden="true"></a>selection</span>
<span id="cb12-2"><a href="#cb12-2" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">call</span>(zoom)</span>
<span id="cb12-3"><a href="#cb12-3" aria-hidden="true"></a>    <span class="op">.</span><span class="fu">on</span>(<span class="st">&quot;dblclick.zoom&quot;</span><span class="op">,</span> <span class="kw">null</span>)<span class="op">;</span></span></code></pre></div>
<p><a href="#zoom_interpolate" name="zoom_interpolate">#</a> <i>zoom</i>.<b>interpolate</b>([<i>interpolate</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L410" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoom_on" name="zoom_on">#</a> <i>zoom</i>.<b>on</b>(<i>typenames</i>[, <i>listener</i>]) <a href="https://github.com/d3/d3-zoom/blob/master/src/zoom.js#L414" title="Source">&lt;&gt;</a></p>
...
<p><a href="#zoomTransform" name="zoomTransform">#</a> d3.<b>zoomTransform</b>(<i>node</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb13"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb13-1"><a href="#cb13-1" aria-hidden="true"></a><span class="kw">var</span> transform <span class="op">=</span> d3<span class="op">.</span><span class="fu">zoomTransform</span>(selection<span class="op">.</span><span class="fu">node</span>())<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb14"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb14-1"><a href="#cb14-1" aria-hidden="true"></a><span class="kw">var</span> transform <span class="op">=</span> d3<span class="op">.</span><span class="fu">zoomTransform</span>(<span class="kw">this</span>)<span class="op">;</span></span></code></pre></div>
...
<p><em>k</em> 0 <em>t<sub>x</sub></em> <br>0 <em>k</em> <em>t<sub>y</sub></em> <br>0 0 1</p>
...
<div class="sourceCode" id="cb15"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb15-1"><a href="#cb15-1" aria-hidden="true"></a><span class="kw">var</span> t <span class="op">=</span> d3<span class="op">.</span><span class="at">zoomIdentity</span><span class="op">.</span><span class="fu">translate</span>(x<span class="op">,</span> y)<span class="op">.</span><span class="fu">scale</span>(k)<span class="op">;</span></span></code></pre></div>
...
<div class="sourceCode" id="cb16"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb16-1"><a href="#cb16-1" aria-hidden="true"></a>context<span class="op">.</span><span class="fu">translate</span>(transform<span class="op">.</span><span class="at">x</span><span class="op">,</span> transform<span class="op">.</span><span class="at">y</span>)<span class="op">;</span></span>
<span id="cb16-2"><a href="#cb16-2" aria-hidden="true"></a>context<span class="op">.</span><span class="fu">scale</span>(transform<span class="op">.</span><span class="at">k</span><span class="op">,</span> transform<span class="op">.</span><span class="at">k</span>)<span class="op">;</span></span></code></pre></div>
<p>Similarly, to apply the transformation to HTML elements via <a href="https://www.w3.org/TR/css-transforms-1/">CSS</a>:</p>
<div class="sourceCode" id="cb17"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb17-1"><a href="#cb17-1" aria-hidden="true"></a>div<span class="op">.</span><span class="fu">style</span>(<span class="st">&quot;transform&quot;</span><span class="op">,</span> <span class="st">&quot;translate(&quot;</span> <span class="op">+</span> transform<span class="op">.</span><span class="at">x</span> <span class="op">+</span> <span class="st">&quot;px,&quot;</span> <span class="op">+</span> transform<span class="op">.</span><span class="at">y</span> <span class="op">+</span> <span class="st">&quot;px) scale(&quot;</span> <span class="op">+</span> transform<span class="op">.</span><span class="at">k</span> <span class="op">+</span> <span class="st">&quot;)&quot;</span>)<span class="op">;</span></span>
<span id="cb17-2"><a href="#cb17-2" aria-hidden="true"></a>div<span class="op">.</span><span class="fu">style</span>(<span class="st">&quot;transform-origin&quot;</span><span class="op">,</span> <span class="st">&quot;0 0&quot;</span>)<span class="op">;</span></span></code></pre></div>
<p>To apply the transformation to <a href="https://www.w3.org/TR/SVG/coords.html#TransformAttribute">SVG</a>:</p>
<div class="sourceCode" id="cb18"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb18-1"><a href="#cb18-1" aria-hidden="true"></a>g<span class="op">.</span><span class="fu">attr</span>(<span class="st">&quot;transform&quot;</span><span class="op">,</span> <span class="st">&quot;translate(&quot;</span> <span class="op">+</span> transform<span class="op">.</span><span class="at">x</span> <span class="op">+</span> <span class="st">&quot;,&quot;</span> <span class="op">+</span> transform<span class="op">.</span><span class="at">y</span> <span class="op">+</span> <span class="st">&quot;) scale(&quot;</span> <span class="op">+</span> transform<span class="op">.</span><span class="at">k</span> <span class="op">+</span> <span class="st">&quot;)&quot;</span>)<span class="op">;</span></span></code></pre></div>
<p>Or more simply, taking advantage of <a href="#transform_toString"><em>transform</em>.toString</a>:</p>
<div class="sourceCode" id="cb19"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb19-1"><a href="#cb19-1" aria-hidden="true"></a>g<span class="op">.</span><span class="fu">attr</span>(<span class="st">&quot;transform&quot;</span><span class="op">,</span> transform)<span class="op">;</span></span></code></pre></div>
<p>Note that the order of transformations matters! The translate must be applied before the scale.</p>
<p><a href="#transform_scale" name="transform_scale">#</a> <i>transform</i>.<b>scale</b>(<i>k</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L9" title="Source">&lt;&gt;</a></p>
<p>Returns a transform whose scale <em>k₁</em> is equal to <em>k₀k</em>, where <em>k₀</em> is this transform’s scale.</p>
<p><a href="#transform_translate" name="transform_translate">#</a> <i>transform</i>.<b>translate</b>(<i>x</i>, <i>y</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L12" title="Source">&lt;&gt;</a></p>
...
<p><a href="#transform_apply" name="transform_apply">#</a> <i>transform</i>.<b>apply</b>(<i>point</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L15" title="Source">&lt;&gt;</a></p>
...
<p><a href="#transform_applyX" name="transform_applyX">#</a> <i>transform</i>.<b>applyX</b>(<i>x</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L18" title="Source">&lt;&gt;</a></p>
<p>Returns the transformation of the specified <em>x</em>-coordinate, <em>xk</em> + <em>t<sub>x</sub></em>.</p>
<p><a href="#transform_applyY" name="transform_applyY">#</a> <i>transform</i>.<b>applyY</b>(<i>y</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L21" title="Source">&lt;&gt;</a></p>
<p>Returns the transformation of the specified <em>y</em>-coordinate, <em>yk</em> + <em>t<sub>y</sub></em>.</p>
<p><a href="#transform_invert" name="transform_invert">#</a> <i>transform</i>.<b>invert</b>(<i>point</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L24" title="Source">&lt;&gt;</a></p>
...
<p><a href="#transform_invertX" name="transform_invertX">#</a> <i>transform</i>.<b>invertX</b>(<i>x</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L27" title="Source">&lt;&gt;</a></p>
<p>Returns the inverse transformation of the specified <em>x</em>-coordinate, (<em>x</em> - <em>t<sub>x</sub></em>) / <em>k</em>.</p>
<p><a href="#transform_invertY" name="transform_invertY">#</a> <i>transform</i>.<b>invertY</b>(<i>y</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L30" title="Source">&lt;&gt;</a></p>
<p>Returns the inverse transformation of the specified <em>y</em>-coordinate, (<em>y</em> - <em>t<sub>y</sub></em>) / <em>k</em>.</p>
<p><a href="#transform_rescaleX" name="transform_rescaleX">#</a> <i>transform</i>.<b>rescaleX</b>(<i>x</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L33" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb20"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb20-1"><a href="#cb20-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">rescaleX</span>(x) {</span>
<span id="cb20-2"><a href="#cb20-2" aria-hidden="true"></a>  <span class="kw">var</span> range <span class="op">=</span> x<span class="op">.</span><span class="fu">range</span>()<span class="op">.</span><span class="fu">map</span>(transform<span class="op">.</span><span class="at">invertX</span><span class="op">,</span> transform)<span class="op">,</span></span>
<span id="cb20-3"><a href="#cb20-3" aria-hidden="true"></a>      domain <span class="op">=</span> range<span class="op">.</span><span class="fu">map</span>(x<span class="op">.</span><span class="at">invert</span><span class="op">,</span> x)<span class="op">;</span></span>
<span id="cb20-4"><a href="#cb20-4" aria-hidden="true"></a>  <span class="cf">return</span> x<span class="op">.</span><span class="fu">copy</span>()<span class="op">.</span><span class="fu">domain</span>(domain)<span class="op">;</span></span>
...
<p><a href="#transform_rescaleY" name="transform_rescaleY">#</a> <i>transform</i>.<b>rescaleY</b>(<i>y</i>) <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L36" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb21"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb21-1"><a href="#cb21-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">rescaleY</span>(y) {</span>
<span id="cb21-2"><a href="#cb21-2" aria-hidden="true"></a>  <span class="kw">var</span> range <span class="op">=</span> y<span class="op">.</span><span class="fu">range</span>()<span class="op">.</span><span class="fu">map</span>(transform<span class="op">.</span><span class="at">invertY</span><span class="op">,</span> transform)<span class="op">,</span></span>
<span id="cb21-3"><a href="#cb21-3" aria-hidden="true"></a>      domain <span class="op">=</span> range<span class="op">.</span><span class="fu">map</span>(y<span class="op">.</span><span class="at">invert</span><span class="op">,</span> y)<span class="op">;</span></span>
<span id="cb21-4"><a href="#cb21-4" aria-hidden="true"></a>  <span class="cf">return</span> y<span class="op">.</span><span class="fu">copy</span>()<span class="op">.</span><span class="fu">domain</span>(domain)<span class="op">;</span></span>
...
<p><a href="#transform_toString" name="transform_toString">#</a> <i>transform</i>.<b>toString</b>() <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L39" title="Source">&lt;&gt;</a></p>
...
<div class="sourceCode" id="cb22"><pre class="sourceCode js"><code class="sourceCode javascript"><span id="cb22-1"><a href="#cb22-1" aria-hidden="true"></a><span class="kw">function</span> <span class="fu">toString</span>() {</span>
<span id="cb22-2"><a href="#cb22-2" aria-hidden="true"></a>  <span class="cf">return</span> <span class="st">&quot;translate(&quot;</span> <span class="op">+</span> <span class="kw">this</span><span class="op">.</span><span class="at">x</span> <span class="op">+</span> <span class="st">&quot;,&quot;</span> <span class="op">+</span> <span class="kw">this</span><span class="op">.</span><span class="at">y</span> <span class="op">+</span> <span class="st">&quot;) scale(&quot;</span> <span class="op">+</span> <span class="kw">this</span><span class="op">.</span><span class="at">k</span> <span class="op">+</span> <span class="st">&quot;)&quot;</span><span class="op">;</span></span>
<span id="cb22-3"><a href="#cb22-3" aria-hidden="true"></a>}</span></code></pre></div>
<p><a href="#zoomIdentity" name="zoomIdentity">#</a> d3.<b>zoomIdentity</b> <a href="https://github.com/d3/d3-zoom/blob/master/src/transform.js#L44" title="Source">&lt;&gt;</a></p>
