...
\begin{enumerate}
	...
	\item \textbf{FILES TO SUBMIT:} SortingAnalysis.pdf
\end{enumerate}

For each experiment, make sure that you are sorting large enough lists such that differences in the algorithm speeds begins to show. If you need to adjust the list sizes so get better results, that is fine (just document your methodology!).
