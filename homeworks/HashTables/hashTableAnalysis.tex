...
\huge Hash Tables - Hash Table Analysis \\ % The assignment title
...
The goal of this homework is to produce a report analyzing optimizations to your hash table implementation. 
...
\begin{enumerate}
	...
	\item \textbf{FILES TO SUBMIT:} HashTableAnalysis.pdf
\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{Introduction}: Present the problem, and provide details regarding the algorithms you implemented (Collision resolution strategies, optimizations, etc.).
