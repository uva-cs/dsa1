...
For this homework, you will be implementing a simple concurrent queue. For this assignment, we are going to focus on correctness (i.e., the queue must work with multiple threads without crashing). Optimizing the speed of your concurrent queue is recommended, but ultimately optional.
...
\begin{enumerate}
	...
	\item \textbf{FILES TO SUBMIT:} ConcurrentQueue.java
\end{enumerate}
...
\begin{enumerate}
  \item Make sure you are only submitting one file, and it is called \emph{ConcurrentQueue.java} exactly.
  \item Make sure you keep the package statement at the top of the file.
  \item Your \emph{ConcurrentQueue.java} should \textbf{NOT contain any imports of any of Java's built-in Queue data structures}.
  \item Make sure your file is \textbf{NOT printing anything extra to the console}.
\end{enumerate}
