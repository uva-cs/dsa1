...
\textbf{IMPORTANT NOTE: The average and standard deviation should be printed as a double to two decimal places. The mode and median should be printed as an integer (because there are always five numbers, there is always a true median). You can handle the floating point values using this line of code:}
